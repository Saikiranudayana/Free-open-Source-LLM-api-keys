# Free Open Source LLM API Keys & Code
...
git clone https://github.com/Saikiranudayana/Free-open-Source-LLM-api-keys
cd Free-open-Source-LLM-api-keys
jupyter notebook

Open any notebook, add your API key, and run the cells.
...
If useful, star the repository and share it.
